const translations = {
  en: {
    ...
    figureTwoLabel: "on Overseas Learning Programs",
    figureThreeValue: "5,000+ Participants",
    ...
    figuresNote: "Figures are based on Maple Leaf Edu-Travel and Maple Leaf Educational Systems organisational records.",
  ...
  zh: {
    ...
    figureTwoLabel: "参与海外学习项目",
    figureThreeValue: "5,000+ 名参与者",
    figureThreeLabel: "参与中国研学项目",
    figureFourValue: "20+ 座城市",
    figureFourLabel: "覆盖枫叶教育网络",
    figuresNote: "以上数据基于枫叶研学交流及枫叶教育集团组织记录。",
